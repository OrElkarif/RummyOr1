...
public class Player1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // יצירת מופע חדש של לוח משחק עבור שחקן 1
            boardGame = new BoardGame(this, true); // true עבור שחקן 1
            ...
            Log.e("Player1Activity", "שגיאה באתחול האקטיביטי: " + e.getMessage());
        }
    }
